      ...
      <div class="sidebar">
        ...
        <div class="sidebar-content">
          <ul class="lists">
            ...
            <li class="list">
              <a href="ad_dashboard.php?user_id=<?php echo $user['id']; ?>" class="nav-link">
    ...
    <div class="container">
        ...
        <div class="box">
                ...
                <?php
                 $dep = $_GET['department']
                 ?>
                <a href="student_sem1.php?user_id=<?php echo $user['id']; ?>&department=<?php echo $user['department']; ?>&semester=<?php echo $user['semester']; ?>" class="btn">read more</a>
            </div>
