    ...
    <div class="container">
        ...
        <div class="box">
                ...
                <?php
                 $dep = $_GET['department']
                 ?>
                <a href="admin_sem1mba.php?user_id=<?php echo $user['id']; ?>&department=MBA&semester=1" class="btn">read more</a>
            </div>
            ...
            <div class="box">
                ...
                <?php
                 $dep = $_GET['department']
                 ?>
                <a href="admin_sem1mba.php?user_id=<?php echo $user['id']; ?>&department=MBA&semester=2" class="btn">read more</a>
            </div>
            ...
            <div class="box">
                ...
                <?php
                 $dep = $_GET['department']
                 ?>
                <a href="admin_sem1mba.php?user_id=<?php echo $user['id']; ?>&department=MBA&semester=3" class="btn">read more</a>
            </div>
            ...
            <div class="box">
                ...
                <?php
                 $dep = $_GET['department']
                 ?>
                <a href="admin_sem1mba.php?user_id=<?php echo $user['id']; ?>&department=MBA&semester=4" class="btn">read more</a>
            </div>
