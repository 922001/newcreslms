      ...
      <div class="sidebar">
        ...
        <div class="sidebar-content">
          <ul class="lists">
            ...
            <li class="list">
              <a href="admin_semmba.php?user_id=<?php echo $user['id']; ?>&&department=MBA" class="nav-link">
                                ...
                                <div class='box'>
                                    ...
                                    echo "<h3>$subject</h3>";
                                     echo "<h4> Course Code : $courseCode</h4>";
                                      ...
                                      echo "<a href='admin_mbasub_description.php?user_id=".$user['id']."&&subject_id=$subjectId'  class='btn'>read more</a>
                                </div>
                             ";
