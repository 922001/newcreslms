     ...
     <div class="banner">
      ...
      <div class="item">
        ...
        <button class="btn"><i class="fa fa-plus"></i> Add</button>
          ...
          <button class="btn" onclick="location.href = 'update.php';"><i class="fa fa-pen"></i> edit</button>
        </div>
        </div>
       ...
       <div class="item">
          <p>Announcement</p>
          <textarea rows="3" name="announcement" id="announcement"></textarea>
        </div>
        <div class="btn-block">
...
//       });
          ...
          function createData()
          {
              ...
              function(e)
              {
                      ...
                      $.ajax({
                          type: "POST",
                          url: '/creslms/announcementCreation.php',
                          data:  $(this).serialize(),
