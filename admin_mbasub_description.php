      ...
      <div class="sidebar">
        ...
        <div class="sidebar-content">
          <ul class="lists">
            ...
            <li class="list">
              <a href="admin_sem1mba.php?user_id=<?php echo $user['id']; ?>&&department=MBA&semester=<?php echo $semester; ?>"  class="nav-link">
                ...
                <div class='accordion-item-body'>
                    <div class='accordion-item-body-content'>
                        ...
                        <div class='checkbox-content'>
                            <a href='http://localhost/creslms/admin_mbavideo.php?user_id=".$user['id']."&subject_id=$var_value&session_id=$id'>
                                <p>$name video</p>
                            </a>
