...
<body>
    ...
    <div class="container">
        <div class="box-container">
            ...
            $sem = $user['semester'];
            $count = 1;
            $img_array = array("mca1.jpg", "mca2.jpg", "mca3.jpg", "mca4.jpg");
            while ($count <= 4) {
                echo " <div class='card'>
            <div class='image'>";
            ...
            <div class='title'>
                <h1>SEM $count</h1>";
                if ($count == $sem) {
                    echo "<button><a href='admin_sem1.php?user_id=" . $user['id'] . "&department=" . $user['department'] . "&semester=" . $user['semester'] . "' class='btn'>read more</a></button>";
                } else {
