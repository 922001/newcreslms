     ...
     <div class="banner">
      ...
      <div class="item">
        ...
        <button class="btn"><i class="fa fa-plus"></i> Add</button>
          ...
          <button class="btn" onclick="location.href = 'update_session.php';"><i class="fa fa-pen"></i> edit</button>
        ...
        <div class="item">
          <select name="session" id="sessionn" required>
            ...
            <option value="session 3">session3</option>
            <option value="session 4">session4</option>
            <option value="session 5">session5</option>
            <option value="sessionn 6">session6</option>
            <option value="session 7">session7</option>
            <option value="session 8">session8</option>
            <option value="session 9">session9</option>
            <option value="session 10">session10</option>
       </select>
        </div>
       <div class="item">
        <p>video content</p>
      ...
      <div class="item">
        ...
        <div class="item">
          <p>Subject ID</p>
          <textarea rows="3" name="subid" id="subid"></textarea>
        </div>
        <div class="btn-block">
...
//       });
          ...
          function createData()
          {
              ...
              function(e)
              {
                      ...
                      $.ajax({
                          type: "POST",
                          url: '/creslms/sessionCreation.php',
                          data:  $(this).serialize(),
