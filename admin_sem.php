...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" href="admin_sem.css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css"/>
      ...
      <div class="sidebar">
        ...
        <div class="sidebar-content">
          <ul class="lists">
            ...
            <li class="list">
              <a href="admin_dashboard.php?user_id=<?php echo $user['id']; ?>" class="nav-link">
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <?php
                 $dep = $_GET['department']
                 ?>
                <button><a href="admin_sem1.php?user_id=<?php echo $user['id']; ?>&department=MCA&semester=1" class="btn">read more</a></button>
            </div>
        </div>
        <!-- card ends -->
        <!--card -->
        <div class="card">
            ...
            <?php
                 $dep = $_GET['department']
                 ?>
                <button><a href="admin_sem1.php?user_id=<?php echo $user['id']; ?>&department=MCA&semester=2" class="btn">read more</a></button>
            </div>
        </div>
        <!-- card ends -->
        <!--card -->
        <div class="card">
            ...
            <?php
                 $dep = $_GET['department']
                 ?>
                <button><a href="admin_sem1.php?user_id=<?php echo $user['id']; ?>&department=MCA&semester=3" class="btn">read more</a></button>
            </div>
        </div>
        <!-- card ends -->
        <!--card -->
        <div class="card">
            ...
            <?php
                 $dep = $_GET['department']
                 ?>
                <button><a href="admin_sem1.php?user_id=<?php echo $user['id']; ?>&department=MCA&semester=4" class="btn">read more</a></button>
            </div>
        </div>
        <!-- card ends -->
